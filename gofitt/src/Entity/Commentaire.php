 ...
 * Commentaire
 *
 * @ORM\Table(name="commentaire", indexes={@ORM\Index(name="FK_Actu", columns={"FK_act"}), @ORM\Index(name="FKproduit", columns={"FK_Prod"}), @ORM\Index(name="Fk_utilisateurCom_id", columns={"Fk_utilisateur_id"})})
 * @ORM\Entity
 */
class Commentaire
{
