 ...
 * Avis
 *
 * @ORM\Table(name="avis", indexes={@ORM\Index(name="FKservice_id", columns={"FK_Service"}), @ORM\Index(name="Fk_utilisateurAvis_id", columns={"Fk_utilisateur_id"}), @ORM\Index(name="FK_Produit_Id", columns={"FK_Produit_Id"})})
 * @ORM\Entity
 */
class Avis
{
