...
{   //PART ADMIN
    ...
    public function index(CommandeRepository $commandeRepository): Response
    {
        ...
        $commandesnotapprocved = $this->getDoctrine()->getRepository(Commande::class)->findBy([], ['dateC' => 'desc']);
...
//    }
    ...
    /**
     * @Route("/validerCommande/{id}", name="passerclient-commande")
     */
    public function validerCommandes($id, CommandeRepository $commandeRepository, UtilisateurRepository $utilisateurRepository): Response
    {
        ...
        $client = $utilisateurRepository->find($commande->getFkClientpan());
        $emailClient = $client->getEmail();
        $this->mailerService->sendEmail($emailClient, array('total' => $commande->getTotal(), 'client' => $client->getNom()));
