 ...
 * Reservation
 *
 * @ORM\Table(name="reservation", indexes={@ORM\Index(name="FK_ClientUser_Id", columns={"FK_user_Id"}), @ORM\Index(name="FK_terrain", columns={"FK_terrain"}), @ORM\Index(name="FKservice", columns={"FK_Service"})})
 * @ORM\Entity
 */
class Reservation
{
